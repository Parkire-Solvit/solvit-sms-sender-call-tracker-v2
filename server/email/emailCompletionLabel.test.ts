...
test('completed emails retain completion timestamp and late outcome', () => {
  assert.equal(emailCompletionOutcome('2026-09-16T07:57:00Z', '2026-09-16T05:30:00Z'), '147 working min late');
...
test('completed lateness excludes nights and weekends', () => {
  assert.equal(emailCompletionOutcome('2026-09-21T05:15:00Z', '2026-09-18T13:45:00Z'), '30 working min late');
  assert.equal(emailCompletionOutcome('2026-09-16T05:15:00Z', '2026-09-15T13:45:00Z', ['2026-09-16']), '15 working min late');
});
